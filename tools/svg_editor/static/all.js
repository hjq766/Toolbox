...
MD.Editor = function(){
  ...
  function exportHandler(window, data) {
    ...
    canvg(c, data.svg, {renderCallback: function() {
      ...
      var filename = "Aoaostar Draw Image";
      var type = 'image/png';
...
editor.modal = {
  about: new MD.Modal({
    html: `
      <h1>关于</h1>
      <p>傲星工具箱：<a target="_blank" href="https://github.com/aoaostar/toolbox">https://github.com/aoaostar/toolbox</a></p>
	  <p>Jqnest在线工具箱<a target="_blank" href="https://tools.jqnest.top">https://tools.jqnest.top</a></p>
      <p>汉化：<a target="_blank" href="https://www.aoaostar.com">Pluto</a></p>
      `
  }),
  source: new MD.Modal({
    html: `
  ...
  donate: new MD.Modal({
    html: `
      <h1>Donate</h1>
      <p>
        <a href="https://www.aoaostar.com/">Donate now</a>
      </p>`
  }),
