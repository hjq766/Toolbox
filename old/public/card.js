...
window.toolCards = {
    ...
    tools: {
        ...
        dev: [
            ...
            {
                href: 'tools/html_preview/index.html',
                icon: 'tabler:brand-html5',
                title: 'HTML实时预览',
                desc: '在线编写HTML、CSS、JS代码并实时预览效果，支持导出'
            },
            {
        ...
        calc: [
            ...
            {
                href: 'tools/sizelinker/index.html',
                icon: 'tabler:aspect-ratio',
                title: '长宽联动工具',
                desc: '根据已知尺寸自动计算按比例缩放的目标尺寸'
            },
            {
        ...
        image: [
            ...
            {
                href: 'tools/images_clipping/index.html',
                icon: 'tabler:crop',
                title: '图片裁剪工具',
                desc: '在线图片裁剪工具，支持自由裁剪、固定比例、旋转翻转'
            },
            {
            ...
            {
                href: 'tools/svg_code_editor/index.html',
                icon: 'tabler:svg',
                title: 'SVG代码编辑器',
                desc: '在线编辑SVG代码，实时预览效果'
            },
			{
			...
			{
                href: 'tools/ps_online/index.html',
                icon: 'simple-icons:adobephotoshop',
                title: '在线Photohop',
                desc: '在线照片处理编辑器'
            },
            {
                href: 'tools/wechat_qrcode/index.html',
